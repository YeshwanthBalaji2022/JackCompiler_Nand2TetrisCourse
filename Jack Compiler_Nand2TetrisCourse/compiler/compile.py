...
root=Tk()
root.title("Jack Compiler")
root.geometry("500x300")
root.configure(bg="#FFFFFF")
frame1 = Frame(root,background="#FFFFFF",height=40,width=500)
lbl1= Label(frame1, text = "Jack Compiler", font=('Arial',25,'bold'),bg="#FFFFFF",fg='#FF0000')
lbl1.pack()
frame1.place(x=170,y=0)
frame2=Frame(root,background="#FFFFFF",height=200,width=500)
btn1 = Button(frame2,command=browseFiles, text="Open File",relief='flat',font=('Ariel',8,'bold'),height=1,bg="#FF0000",fg="#FFFFFF",activebackground="#FFFFFF",activeforeground="#000FFF")
btn1.place(x=125,y=20)
btn2 = Button(frame2,command=browseDirectory, text="Open directory",relief='flat',font=('Ariel',8,'bold'),height=1,bg="#FF0000",fg="#FFFFFF",activebackground="#FFFFFF",activeforeground="#000FFF")
